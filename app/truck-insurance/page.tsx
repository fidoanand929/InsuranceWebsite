            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  <span className="text-base font-medium text-gray-500 dark:text-gray-400">{plan.priceDetail}</span>
                </div>
...
const features = [
  {
    ...
    description: "Protection for your trucks, cargo, and liability coverage all in one package.",
...
const plans = [
  {
    name: "Basic Coverage",
    description: "Perfect for single truck operators",
    price: "$X",
    priceDetail: "/month",
    features: [
      "Liability coverage",
  ...
  {
    name: "Fleet Special",
    description: "Complete fleet protection",
    price: "Custom",
    priceDetail: "pricing",
    features: [
      "Full fleet coverage",
